...
// Row 1: Valid
stream.write(`Valid User,valid${timestamp}@test.com,+919999999999,MALE,${DEPT_ID},${BATCH_ID}\n`);

// Row 2: Invalid email
stream.write(`Invalid Email,invalid-email,+919999999998,MALE,${DEPT_ID},${BATCH_ID}\n`);

// Row 3: Invalid phone (too short)
stream.write(`Invalid Phone,valid2${timestamp}@test.com,+910000,FEMALE,${DEPT_ID},${BATCH_ID}\n`);

// Row 4: Invalid gender
stream.write(`Invalid Gender,valid3${timestamp}@test.com,+919999999997,INVALID,${DEPT_ID},${BATCH_ID}\n`);

// Row 5: Missing required field (no name)
stream.write(`,valid4${timestamp}@test.com,+919999999996,MALE,${DEPT_ID},${BATCH_ID}\n`);
