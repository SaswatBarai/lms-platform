...
- **OpenAPI spec**: `services/auth-service/docs/openapi/openapi.yaml`
...
- Make sure you're editing files in `services/auth-service/docs/openapi/` (not inside the container)
