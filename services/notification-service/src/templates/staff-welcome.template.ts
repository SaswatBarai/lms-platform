      ...
      <div class="email-body">
        <div class="welcome-section">
          ...
          <p class="welcome-message">
            You now have access to the LMS Platform as a staff member for ${collegeName}. Use the temporary credentials below to log in and start accessing your resources.
          </p>
        </div>
      ...
      <div class="email-footer">
        <div class="footer-content">
          <div class="footer-info">
            ...
            <div class="footer-college">Staff Portal</div>
          </div>
