export const deanPasswordResetEmailTemplate = (
  email: string,
  sessionToken: string,
  collegeName: string,
  resetUrl: string
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="message">
        We received a request to reset your password for your Dean account. 
      ...
      <div class="info-box">
        ...
        <div class="info-row">
          ...
          <span class="info-value">Dean</span>
        </div>
      </div>
